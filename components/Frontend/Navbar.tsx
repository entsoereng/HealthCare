...
export default function Navbar() {
  ...
  return (
    <div className="bg-white">
      <header className="fixed inset-x-0 top-0  bg-slate-50 z-50 h-auto">
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            {navigation.map((item) => (
              <a key={item.name} href={item.href} className="text-xl font-semibold leading-6 text-gray-950">
                {item.name}
              </a>
            ))}
          </div>
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            <a href="#" className="text-sm bg-blue-700 py-3 px-6 rounded-md font-semibold leading-6 text-gray-50">
